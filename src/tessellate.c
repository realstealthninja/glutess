...
struct TessContext_s *new_tess_context() {
  struct TessContext_s *result =
      (struct TessContext_s *)malloc(sizeof(struct TessContext_s));
...
struct Triangle_s *new_triangle(struct TessContext_s *ctx, int v1, int v2,
                                int v3) {
  struct Triangle_s *result =
      (struct Triangle_s *)malloc(sizeof(struct Triangle_s));
...
void write_output(struct TessContext_s *ctx, double **coordinates_out,
                  int **tris_out, int *vc, int *tc) {
...
void tessellate(double **verts, int *nverts, int **tris, int *ntris,
                const double **contoursbegin, const double **contoursend) {
