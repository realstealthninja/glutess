...
void run_example(const double vertices_array[], const double *contours_array[],
                 int contours_size) {
  ...
  tessellate(&coordinates_out, &nverts, &tris_out, &ntris, contours_array,
...
int main() {
  ...
  double a3[] = {441, 0,   326, 0,   326, 889, 12,  889,
                 12,  992, 755, 992, 755, 889, 441, 889};
